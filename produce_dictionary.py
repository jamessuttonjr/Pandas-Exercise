...
print()
print('Max: ', produce['Total Sale'].idxmax(), '--', produce['Total Sale'].max())
print('Min: ', produce['Total Sale'].idxmin(), '--', produce['Total Sale'].min())
print()
...
print('Updated Quantity Sold: ', produce.at['Apricots','Quantity Sold'])
print('Updated Total Sale: ',produce.at['Apricots','Total Sale'])
print()


print("What is the average quantity sold across all products? (print out ONLY quantity sold)")
print()
print("Average quantity Sold Overall: ", produce['Quantity Sold'].mean())
print()

print("Create a new dataframe for only those produce that have sold between 11,500 to 12,000 (quantity)")
print()
print("Produce sold between 11,500 and 12,000: ")
produce_between_11500_12000 = produce[(produce['Quantity Sold'] > 11500) & (produce['Quantity Sold'] < 12000)]
print(produce_between_11500_12000)
print()
...
print()
print("Total Sales for above Data Frame: ")
print(produce_between_11500_12000['Total Sale'])
